...
class CurrencyTest extends TestCase {
    ...
    public function test_formats_amount_4() {
        $eur = new Currency('USD');
        $this->assertEquals('560.00', $eur->format(new Decimal2('560.00')));
        $this->assertEquals('-1,560.00', $eur->format(new Decimal2('-1560.00')));
        $this->assertEquals('-100,000,000,000.00', $eur->format(new Decimal2('-100000000000.00')));
    }

    public function test_formats_amount_5() {
        $eur = new Currency('TWD');
        $this->assertEquals('560.00', $eur->format(new Decimal2('560.00')));
        $this->assertEquals('-1560.00', $eur->format(new Decimal2('-1560.00')));
        $this->assertEquals('-100000000000.00', $eur->format(new Decimal2('-100000000000.00')));
    }
}
